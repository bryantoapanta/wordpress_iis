...
/* CODIGO QUE MUESTRA VALORES DE LA BD POR_USUARIOS  EN PAGINA GESTIONAR */
...
add_filter('the_content', 'dcms_list_data_ranking');

function dcms_list_data_ranking ($content)
{
	$slug_page = 'rankings'; //slug de la página en donde se mostrará la tabla
	$table_name = 'paginas_portal'; // nombre de la tabla
	$dbuser     = 'system';
	$dbpassword = 'capote';
	$dbname     = 'apoyo_luxenter';
